defmodule AuthorizeWeb.Access.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AuthorizeWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule AuthorizeWeb.PageLive do
        use AuthorizeWeb, :live_view

        on_mount {AuthorizeWeb.Access.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AuthorizeWeb.Access.UserAuth, :ensure_authenticated}] do
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_user do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/access/users/log_in")
